...
if 0:
    ...
    # temperature section.
    data_1 = td.ThermistorData("260604_calibration/260603_193804.txt")
    fig_1 = data_1.quick_plot(save_to_disk=True)
    plt.show()

data = [
    td.ThermistorData("260604_calibration/260603_193804_1_ramp_up.txt"),
    td.ThermistorData("260604_calibration/260603_193804_2_ramp_down.txt"),
    td.ThermistorData("260604_calibration/260603_193804_3_ramp_up.txt"),
    td.ThermistorData("260604_calibration/260603_193804_4_ramp_down.txt"),
