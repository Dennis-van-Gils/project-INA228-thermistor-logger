...
if 0:
    ...
    # temperature section.
    data_1 = td.ThermistorData("260602_calibration/260602_174128.txt")
    fig_1 = data_1.quick_plot(save_to_disk=True)
    plt.show()

data = [
    td.ThermistorData("260602_calibration/260602_174128_1_ramp_up.txt"),
    td.ThermistorData("260602_calibration/260602_174128_2_ramp_down.txt"),
    td.ThermistorData("260602_calibration/260602_174128_3_ramp_up.txt"),
    td.ThermistorData("260602_calibration/260602_174128_4_ramp_down.txt"),
