...
if 0:
    ...
    # temperature section.
    data_1 = td.ThermistorData("260511_calibration/260511_151804.txt")
    fig_1 = data_1.quick_plot(save_to_disk=True)
    plt.show()

data = [
    td.ThermistorData("260511_calibration/260511_151804_1_ramp_up.txt"),
    td.ThermistorData("260511_calibration/260512_185755_1_ramp_up.txt"),
    td.ThermistorData("260511_calibration/260512_185755_2_ramp_down.txt"),
    td.ThermistorData("260511_calibration/260512_185755_3_ramp_up.txt"),
]
